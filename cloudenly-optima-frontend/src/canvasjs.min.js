...
(function() {
  ...
  function U(g, l, v, w, qa) {
    ...
    this.theme && s(this.parent) && s(l) && s(w)
      ...
      : this.parent &&
        this.parent.themeOptions && this.parent.themeOptions[l] &&
        (null === w
  ...
  U.prototype.updateOption = function(g) {
    ...
    this.theme && s(this.parent) && s(F) && s(J)
      ? (w = s(this.predefinedThemes[this.theme])
          ...
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions && this.parent.themeOptions[F] &&
        (null === J
  ...
  y = Oa.Chart = (function() {
      ...
      for (var e = 0; e < c.length; e++)
        if ((s(b[c[e]]) && (b[c[e]] = []), "axisY" === c[e]))
          for (var f = 0; f < this.axisY.length; f++)
            b[c[e]].push({
              viewportMinimum: this[c[e]][f].sessionVariables
                .newViewportMinimum,
      ...
      if (
        ...
        if (this.panEnabled || this.zoomEnabled) {
          ...
          p &&
            ...
            this.stockChart &&
              this.stockChart.navigator && this.stockChart.navigator.enabled &&
    ...
    l.prototype.renderLine = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          var r = k._colorSet,
            g = (r = k.lineColor = k.options.lineColor
              ? k.options.lineColor
              : r[0]);
          b.strokeStyle = r;
          var l = !0,
      ...
      function d() {
        if (k && m) {
          ...
          for (e = 0; e < m.length; e++)
            (g = h[(b + e) % m.length]),
              1 < a &&
                g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u &&
                (f <= a / 2 && !n
        ...
        function b() {
          ...
          for (var p, g = 1; g < k; g++) {
            ...
            for (var t = I.length - 1; 0 <= t; t--)
              !I[t].isDirty &&
                I[t].textBlock.y < e && I[t].textBlock.y + I[t].height > e &&
                ((p = q(t)),
                !(p >= I.length - 1) &&
    ...
    E.prototype.showCrosshair = function(a) {
      s(a) ||
        a < this.viewportMinimum || a > this.viewportMaximum ||
        ...
        (a = d.axisY2[c]._crosshairValue),
          d.axisY2[c].crosshair &&
            d.axisY2[c].crosshair.enabled &&
              !s(a) &&
              d._crosshairY2Value >= d.axisY2[c].viewportMinimum &&
              d._crosshairY2Value <= d.axisY2[c].viewportMaximum &&
        ...
        for (var g = 0; g < this.chart.data.length; g++)
          (b = this.chart.data[g]),
            (c = b.getDataPointAtX(a, !1)) &&
              c.dataPoint && !s(c.dataPoint.y) && b.visible &&
