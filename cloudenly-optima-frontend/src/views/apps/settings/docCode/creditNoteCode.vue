<template>
  <div class="container">
    <div>
      <h3 class="text-2xl">Credit Note</h3>
    </div>
    <div>
      <div class="mb-8">
        <div class="">
          <p class="p-3 mb-0">
            A code will be generated for any credit note you save....
          </p>
              ...
              <div class="w-1/3">
                ...
                >
                  <option disabled selected value
                    >Select preferred Code Separator</option
                  >
...
export default {
  ...
  mounted() {
    ...
    //   .catch(err => {
    //     console.log(err);
    //     //    notify user that code format is not set
    //   });
    // let data = {
    //   userInfo: userInfo,
    //   payload: {
