<template>
  <div>
    ...
    <div
      v-if="getServiceMarkupDiscount.length > 0"
      class="bg-white py-6 px-5 font-light text-base text-gray-500 rounded-md"
    >
      <p class="mb-2">
    ...
    <div
      ...
      <div class="flex justify-between items-center">
        ...
        <div v-if="getServiceMarkupDiscount.length > 0">
          <p
          ...
          <tbody>
            <tr
              class="
                ...
                font-normal
              "
              v-for="(markupDiscount, index) in getServiceMarkupDiscount"
              :key="index"
            >
              <td
                class="
          ...
          <s-table :headers="headers" :items="[]" :emptyStateImg="img">
            <div slot="title">
              <p class="text-xl font-bold">
                There are no markup & discount at the moment
              </p>
            </div>
            <div slot="body">
              <p>
                When a customer initiates an action or submits a form/ document,
                they show up here
              </p>
            </div>
        ...
        <div class="flex py-4 items-center text-black text-sm space-x-5">
          <label
            ...
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.amount"
          /></label>
          <label
            >Markup (%):
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.markupPercent"
            />
          </label>
        </div>
        <div class="flex py-4 text-black items-center text-sm space-x-5">
          <label for=""
            ...
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.salesPrice"
          /></label>
          <label for=""
            >Sales Margin (NGN):
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.salesMargin"
            />
          </label>
        </div>
        <div class="flex py-4 items-center text-black text-sm space-x-5">
          <label class="text-black" for=""
            ...
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.salesMarginPercentage"
          /></label>
          <label for=""
            ...
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.maximumAllowableDiscount"
            />
          </label>
        </div>
        <div class="flex py-4 items-center text-black text-sm space-x-5">
          <label for=""
            ...
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.minimumSalesPrice"
          /></label>
          <label for=""
            >Margin at Maximum Discount (NGN):
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.marginAtMaximumDiscount"
            />
          </label>
        </div>
        <div class="flex py-4 items-center text-black text-sm space-x-5">
          <label for=""
            ...
            <s-text
              ...
              :width="270"
              class="mt-3"
              v-model="markupDiscountServiceData.marginAtMinimumDiscount"
          /></label>
        </div>
        <div class="flex py-4 items-center text-black text-sm space-x-5">
        ...
        <div class="space-x-5 flex items-center">
          <label class="flex items-center">
            <input
              type="radio"
              name="select1"
              v-model="markupDiscountServiceData.allowLocationAdminsModify"
              :value="true"
              class="mr-2"
              checked
            />
                ...
                <div class="space-x-5 py-5 flex items-center">
                  <label class="flex items-center">
                    <input
                      ...
                      name="mod"
                      v-model="
                        updateMarkupDiscountServiceData.overrideAllItemBasedModifications
                      "
                      :value="true"
                      class="mr-2"
                    />
                ...
                <div class="space-x-5 py-5 flex items-center">
                  <label class="flex items-center">
                    <input
                      ...
                      name="mod1"
                      v-model="
                        updateMarkupDiscountServiceData.overrideLocationBasedModifications
                      "
                      :value="true"
                      class="mr-2"
                      checked
            ...
            <div class="flex py-4 text-black items-center text-sm space-x-5">
              <label for=""
                ...
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.amount"
              /></label>
              <label for=""
                >Markup (%):
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.markupPercent"
                />
              </label>
            </div>
            <div class="flex py-4 text-black items-center text-sm space-x-5">
              <label for=""
                ...
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.salesPrice"
              /></label>
              <label for=""
                >Sales Margin (%):
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.salesMargin"
                />
              </label>
            </div>
            <div class="flex py-4 items-center text-black text-sm space-x-5">
              <label class="text-black" for=""
                ...
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.salesMarginPercentage"
              /></label>
              <label for=""
                >Maximum allowable (%):
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.maximumAllowableDiscount"
                />
              </label>
            </div>
            <div class="flex py-4 items-center text-black text-sm space-x-5">
              <label for=""
                ...
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.minimumSalesPrice"
              /></label>
              <label for=""
                >Margin at Maximum Discount (NGN):
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.marginAtMaximumDiscount"
                />
              </label>
            </div>
            <div class="flex py-4 items-center text-black text-sm space-x-5">
              <label for=""
                ...
                <s-text
                  ...
                  :width="270"
                  class="mt-3"
                  v-model="updateMarkupDiscountServiceData.marginAtMinimumDiscount"
              /></label>
            </div>
            <div class="flex py-4 items-center text-black text-sm space-x-5">
              <label for="">Allow Location Admins to Modify: </label>
            ...
            <div class="space-x-5 flex items-center">
              <label class="flex items-center">
                <input
                  type="radio"
                  name="select1"
                  v-model="updateMarkupDiscountServiceData.allowLocationAdminsModify"
                  :value="false"
                  class="mr-2"
                />
                Yes
    ...
    <div class="mt-6" v-if="getServiceMarkupDiscount.length > 0">
...
export default {
  ...
  data() {
    return {
      ...
      updateMarkupDiscountServiceData: {
        outletName: "",
        amount: "",
        salesPrice: "",
        salesMargin: "",
  ...
  methods: {
    ...
    saveMarkupDiscount() {
      ...
      let data = {
        ...
        payload: this.markupDiscountServiceData,
      };
    ...
    updateMarkupDiscount() {
      ...
      let data = {
        ...
        payload: {
          // outletName: this.updateMarkupDiscountServiceData.outletName,
          amount: this.updateMarkupDiscountServiceData.amount,
          salesPrice: this.updateMarkupDiscountServiceData.salesPrice,
          salesMargin: this.updateMarkupDiscountServiceData.salesMargin,
          minimumSalesPrice:
            this.updateMarkupDiscountServiceData.minimumSalesPrice,
          marginAtMaximumDiscount:
            this.updateMarkupDiscountServiceData.marginAtMaximumDiscount,
          overrideLocationBasedModifications:
            (this.updateMarkupDiscountServiceData.overrideLocationBasedModifications = false),
          overrideAllItemBasedModifications:
            (this.updateMarkupDiscountServiceData.overrideAllItemBasedModifications = false),
          markupPercent: this.updateMarkupDiscountServiceData.markupPercent,
          salesMarginPercentage:
            this.updateMarkupDiscountServiceData.salesMarginPercentage,
          maximumAllowableDiscount:
            this.updateMarkupDiscountServiceData.maximumAllowableDiscount,
          marginAtMinimumDiscount:
            this.updateMarkupDiscountServiceData.marginAtMinimumDiscount,
          allowLocationAdminsModify:
            (this.updateMarkupDiscountServiceData.allowLocationAdminsModify = true),
          // ...this.updateMarkupDiscountServiceData,
          // ...this.markupDiscountServiceData.id
        },
      };
      this.$store
  ...
  computed: {
    ...
    ...mapGetters("catalogue/markupDiscount", ["getServiceMarkupDiscount"]),
  },
  
  mounted() {
    this.$store.dispatch(
      "catalogue/markupDiscount/getAllServiceMarkupDiscountAction"
    );
    this.$store
      .dispatch("userOutlet/getOptimaOrganisationOutlet")
      .then((resp) => {
        this.markupDiscountServiceData.outletData = resp.data.outlets.map(
          (resp) => {
            return {
