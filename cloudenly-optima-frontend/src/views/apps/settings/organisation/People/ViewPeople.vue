  ...
  <div style="font-size: 14px">
    ...
    >
      ...
      >
        ...
        <s-text disabled label="Middle:" class="col-span-4" v-model="user.mname" />

        <s-text disabled label="Last Name:" class="col-span-4" v-model="user.lname" />
        ...
        <s-text disabled label="Phone:" class="col-span-4" v-model="user.phoneNo" />
