<template>
  <div class="bg-white">
    <s-modal :modal="editMainVariantModal">
      <div style="width: 450px" class="py-2 px-2">
        <p class="text-lg font-bold">Update Item</p>

        <div class="mb-5 mt-8">
          <form>
            <div class="flex flex-col mb-4">
              <label class="mb-2">Name</label>
              <input v-model="mainVariant.name" class="py-2 px-2 rounded-sm border-1 border-gray-500 w-full" type="text">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2">Category</label>
              <input v-model="mainVariant.category.name" class="py-2 px-2 rounded-sm border-1 border-gray-500 w-full" type="text">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2">Brand</label>
              <input v-model="mainVariant.brand" class="py-2 px-2 rounded-sm border-1 border-gray-500 w-full" type="text">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2">Description</label>
              <input v-model="mainVariant.description" class="py-2 px-2 rounded-sm border-1 border-gray-500 w-full" type="text">
            </div>
        ...
        <div class="flex items-center justify-between mt-8 mb-3">
          <button
            ...
            class="py-4 px-8 font-bold bg-gray-300 rounded-full"
          >
            Cancel
          </button>
...
export default {
  ...
  computed: {
    ...mapGetters("catalogue/productItem", ["getProductGroupItem"]),
    ...
    filterItem() {
      return this.getProductGroupItem.filter(resp => {
        return resp.name
          .toLowerCase()
  ...
  mounted() {
    this.$store.dispatch(
      "catalogue/productItem/getProductGroupActionOrganization"
    );
  }
};
</script>
