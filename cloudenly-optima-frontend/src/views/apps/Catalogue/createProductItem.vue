...
<template>
  <div>
    <back location="Create Product New Item" />

    <!-- updated create brand name modal -->
    <s-modal :modal="modalBrand">
      <div class="container">
        <div class="flex items-center justify-between mb-10">
          <h1 class="text-primary-optima-color">Create New Brand</h1>

          <svg
            role="button"
            @click="modalBrand = false"
        ...
        <div class="mt-4">
          ...
          <div class="mt-2">
            <select
              v-model="categoryIds"
              class="py-2 px-2 border border-2 border-gray-600 w-full select"
              name
              id
            >
              <option
    ...
    <s-modal :modal="modalCategory">
      <div class="container">
        <div class="flex items-center justify-between mb-10">
          <h1 class="text-primary-optima-color">Create New Category</h1>
        ...
        <div class="mt-4">
          ...
          <div class="">
            <select
              v-model="categoryIds"
              class="py-2 px-3 border border-2 border-gray-400 w-full select"
              name
              id
            >
              <option
    ...
    <s-modal :modal="supplierModal">
      <div class="container">
        <div class="flex items-center justify-between mb-10">
          <h1 class="text-primary-optima-color">New Supplier</h1>
    ...
    <s-modal :modal="setupModal">
      <div class="container">
        <div class="flex items-center justify-between mb-10">
          <h1 class="text-primary-optima-color">Define Variant Information</h1>

          <svg
            role="button"
            @click="setupModal = false"
            class="cursor-pointer"
            width="18"
            height="18"
            viewBox="0 0 18 18"
    ...
    <Drawer v-on:closeDrawer="close" :visible="skuSetupDrawer" :size="50">
      <div slot="title">
          ...
          <div class="bg-white py-10 px-8">
            <div class="grid grid-cols-12 gap-10">
              ...
              <div class="col-span-4 flex items-end">
                ...
                <div
                  class="w-full"
                  v-else-if="roots.type === 'issuingAuthority'"
                >
                  <s-text
                    class="w-full"
                    placeholder="Enter name or abbreviation"
    ...
    <Drawer v-on:closeDrawer="close" :visible="taxDrawer" :size="50">
      ...
      <div slot="body">
        <div v-if="!getOutletCountry[0]">
          <p class="text-lg">
            You have not complete your organization location set up
            <a
              class="text-cloudenly-primary-main cursor-pointer"
              @click.prevent="routeEditLocation"
              >Click here to complete the set up</a
            >
          </p>
        </div>
        ...
        <div
          v-else
          class="bg-white grid grid-cols-12 px-6 py-8 col-gap-16 gap-8 rounded"
        >
          <h2 class="col-span-12 mb-12 font-semibold">Tax Jurisdiction</h2>

          <s-select
            label="Country:"
            :options="getUniqueLocation('country', countryList)"
            class="col-span-4"
            v-model="country"
          />
          ...
          <s-select
            label="State:"
            :options="getUniqueLocation('state', stateList)"
            class="col-span-4"
            v-model="state"
          />
          ...
          <!-- <div class="col-span-12 flex items-center mb-8">
            <div class="mr-10 font-medium">Tax Policy</div>
    ...
    <!-- Discount -->
    <s-modal :modal="retailModal">
      <div class="container">
        <div class="flex items-center justify-between mb-10">
          <h1 class="text-primary-optima-color">Define Discount Limit</h1>

          <svg
            role="button"
            @click="retailModal = false"
            class="cursor-pointer"
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <div class="flex items-center justify-between bg-white p-6 mb-5">
          <div class="flex items-center">
            <h2 class="font-semibold mr-8">Markup & Margin Settings:</h2>
        ...
        <div class="grid grid-cols-12 row-gap-12 gap-10 bg-white py-6 w-full">
          <s-text
            label="Unit Purchase Price (NGN):"
            type="number"
            class="col-span-6"
            @keyup="handleCalculation"
            v-model.number="setting.price"
          />
          ...
          <s-text
            ...
            class="col-span-6"
            @keyup="handleCalculation"
            v-model.number="setting.minPercentageMarkup"
          />
          ...
          <s-text
            ...
            class="col-span-6"
            @keyup="handleCalculation"
            v-model.number="setting.maxDiscountLimit"
          />

          <s-text
            label="Margin at Max. Discount (NGN):"
            class="col-span-6"
            disabled
          ...
          <s-text
            label="Percentage Margin at Max. Discount (%):"
            class="col-span-6"
            disabled
    ...
    >
      ...
      <div class="py-12 px-8 flex justify-between bg-white">
        <div>
          <button
            @click="$router.back()"
            type="button"
...
export default {
  ...
  data() {
    return {
      ...
      costManageDisableState: false,
      salesDisableState: false,
      inventoryDisableState: false,
    };
  },
    ...
    toggleNext(val) {
      ...
      switch (state) {
        ...
        case "productDetail":
          ...
          if (this.queryInfo.type === "new-item") {
    ...
    getVariantValueKey() {
      ...
      let filterValue = this.getItemCharacteristic.filter((resp) => {
        if (resp.characteristic === itemCharacteristics) {
          ...
          return resp.itemCharacteristicsData;
        }
      });
      console.log(filterValue[0].itemCharacteristicsData, "This is you");
      this.itemCharacteristicsValue = filterValue[0].itemCharacteristicsData;
    },
  ...
  mounted() {
    ...
    switch (this.queryInfo.type) {
      ...
      case "new-item":
        ...
        this.$store.dispatch(
          "catalogue/itemCharacteristics/getItemCharacteristic"
        );
        ...
        this.$store
          ...
          .then((resp) => {
            ...
            if (resp.data === "") {
              this.variant.retailDiscountLimit = 0;
              this.variant.retailMaximumSalesMarkup = 0;
            } else {
              this.variant.retailDiscountLimit =
                resp.data.setting.maxDiscountLimit;
              this.variant.retailMaximumSalesMarkup =
                resp.data.setting.minPercentageMarkup;
            }
          })
          .catch((err) => {
            console.log(err);
        ...
        this.$store
          ...
          .then((resp) => {
            if (resp.data === "") {
              this.variant.wholesaleDiscountLimit = 0;
              this.variant.wholesaleMaximumSalesMarkup = 0;
            } else {
              this.variant.wholesaleDiscountLimit =
                resp.data.setting.maxDiscountLimit;
              this.variant.wholesaleMaximumSalesMarkup =
        ...
        this.$store.dispatch("catalogue/getSkuCode").then((resp) => {
          if (resp.data.setting) {
            let format = resp.data.setting.codeFormat;
            this.suffix = format.suffix;
            (this.prefix = format.prefix), (this.roots = format.roots[0]);
      ...
      case "edit-item":
        ...
        this.$store
          ...
          .then((resp) => {
            ...
            console.log(resp.data, "This is item information");
            this.isItemDetailCreated = true;
        ...
        this.$store
          ...
          .then((resp) => {
            // console.log(resp.data ,  'This is unit information')
        ...
        this.$store
          ...
          .then((resp) => {
            ...
            if (
              resp.data.responseObject.variantSupplierInformation.length === 0
            ) {
              this.variantSuppliers = [
                {
                  name: null,
        ...
        this.$store
          ...
          .then((resp) => {
            ...
            if (resp.data.variants.length === 0) {
              ...
              this.wholesalePriceBooks =
                resp.data.variants[0].wholesalePriceBooks;
