...
<template>
  <div class>
    ...
    <div
      v-if="`getIsAccOwner` || getPurchaseCataloguePrivileges.editItem"
      class="mt-5">
      <!-- Product Details -->
      <section>
        <div>
            ...
            <div class="flex mt-10 mb-5">
              ...
              >
                ...
                <div class>
                  ...
                  <!-- <div
                    class="error text-cloudenly-danger-main mt-2"
                    v-if="errors.has('part number')"
                  >
                    {{ errors.first("part number") }}
                  </div> -->
                </div>
              </div>
              ...
              >
                ...
                <div class>
                  ...
                  <!-- <div
                    class="error text-cloudenly-danger-main mt-2"
                    v-if="errors.has('productDetail.Barcode')"
                  >
                    {{ errors.first("productDetail.Barcode") }}
                  </div> -->
                </div>
              </div>
            </div>
        ...
        <div class="py-8 px-10 bg-white rounded flex justify-end">
          <button
          ...
          <div>
            <div class>
              <!-- <table class="table min-w-full mt-10">
                ...
                <tbody>
                  <tr
                    v-for="(supplier, index) in variantSuppliers"
                    :key="index"
                  >
                    <td class="py-2 px-2 text-center">
                      <input
                        class="leading-tight w-5 bg-cloudenly-primary-main text-cloudenly-primary-main"
                        type="radio"
                    ...
                    <td class="py-2 px-2">
                      <select
                        ...
                        name
                        class="w-full rounded border border-gray-400 py-2"
                        id
                      >
                        <option
                    ...
                    <td class="py-2 px-2">
                      <input
                        ...
                        type="text"
                        class="w-full rounded border border-gray-400 py-2 px-2"
                        name
                        id
                      />
                    </td>
                    ...
                    <td class="py-2 px-2">
                      <div class="flex items-center">
                        <input
                          ...
                          class="w-full border border-gray-400 py-2 px-2 rounded"
                          type="text"
                        />
                      </div>
                    </td>
                ...
                <div>
                  <div class="mt-8 mb-3">
                    <select
                      ...
                      v-model="taxType"
                      class="py-2 px-2 rounded border-2 border-gray-400 w-1/4"
                      name
                      id
                    >
          ...
          <div class="mt-10 mb-10">
            <div class="flex justify-end">
              <button
                ...
                type="button"
                :class="{
                  'cursor-not-allowed': updateInventoryInfoButton,
                  'text-cloudenly-primary-mid': updateInventoryInfoButton,
                }"
                class="
                  inline-flex
                  items-center
...
export default {
  ...
  data() {
    return {
      ...
      isPurchaseInfoCreated: false,
      isSaleInfoCreated: false,
      isInventoryInfoCreated: false,
    };
  },
  ...
  methods: {
    ...
    createOrUpdateInventory() {
      if (this.isInventoryInfoCreated === true) {
      ...
      switch (state) {
        ...
        case "purchaseState":
          ...
          this.retailPriceBooks = this.retailPriceBooks.map((resp, i) => {
            // console.log(this.unitsOfMeasure.unitOfSale , i);
            return {
    ...
    addVariantSuppliers() {
      this.variantSuppliers.push({
        ...
        quantityPerUnit: this.variantSuppliers[0].quantityPerUnit,
        pricePerUnit: 0,
        unitSupplied: 0,
    ...
    calculateWeightedPurchaseAverage() {
      ...
      for (var a = 0; a < this.variantSuppliers.length; a++) {
        sumTotalSupplied =
          sumTotalSupplied + parseInt(this.variantSuppliers[a].quantityPerUnit);
      }
      ...
      this.variantSuppliers = this.variantSuppliers.map((resp) => {
        return {
          ...
          // skuPrice : this.calcSkuPrice(resp.pricePerUnit , resp.quantityPerUnit),
