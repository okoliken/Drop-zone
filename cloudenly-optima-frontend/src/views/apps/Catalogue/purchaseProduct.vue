<template>
  <div>
        ...
        <div class="vx-col w-full md:w-1/3 lg:w-1/3 xl:w-1/3">
          <div class="flex flex-end items-center justify-end">
            ...
            <!-- <drop-down>
              <div slot="title">
                <button
                  class="inline-flex items-center py-3 px-5 rounded-full bg-gray-200"
                >
                  <span class="mr-2">Import/Export</span>
                  <feather-icon
            ...
            <!-- <vs-dropdown vs-custom-content vs-trigger-click>
              <button  @click.prevent="routeCreateItem"  class="inline-flex items-center    
                border-0 py-1 px-2 cursor-pointer rounded bg-cloudenly-primary-main text-white">
    ...
    >
      <!-- <div>  -->
      <div class="bg-white">
        <div class v-if="filterItem.length > 0">
          <div class>
            <table class="table min-w-full">
              <thead>
                <tr>
                  <th
                    class="py-4 px-6 tracking-wider bg-gray-300 font-semibold"
                  >
                    Name
                  </th>
                  <th
              ...
              <tbody>
                ...
                >
                  ...
                  >
                    ...
                    <span v-else>{{ item.category | formatCat }}</span>
                  </td>
                  <td
                    @click="routeViewVariant(item)"
                    class="
        ...
        <div v-else>
          ...
          >
            <thead class="bg-grey-lighter border-grey-light">
              <tr>
...
export default {
  ...
  computed: {
    ...
    filterItem() {
      return this.getallPurchaseProduct.filter((resp) => {
  ...
  methods: {
    ...
    updateMainVariant() {
      this.updateMainVariantButton = true;
      ...
      // console.log(data)
      this.$store
        .dispatch("catalogue/updateMainVariant", data)
        .then((resp) => {
          this.$vs.notify({
            title: "Item",
            position: "top-right",
          ...
          this.updateMainVariantButton = false;
  ...
  mounted() {
    this.$store.dispatch("catalogue/getAllPurchaseProduct");
