<template>
  <div>
    <h1 class="font-semibold mb-8">Promo Analytics</h1>
    <div
      class="flex items-center justify-between rounded-md bg-white px-8 py-6"
    >
      <div
        class="flex items-center w-full mx-8 border-2 border-l-0 border-t-0 border-b-0"
      >

        <div>
          <p class="font-semibold py-4  text-primary-optima-color text-xl">
           26789
          </p>
          <p class=" text-lg">Promo Identifier</p>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <p class="font-bold  py-4 text-danger-optima-color text-xl">
          Health day 
          </p>
          <p class="text-lg">Promo Name</p>
        </div>
      </div>

      <div class="flex items-center w-full mx-5  border-2 border-l-0 border-t-0 border-b-0">
     

        <div>
          <p class="font-semibold py-4 text-cloudenly-primary-mid text-xl">
           QRTAER
          </p>
      ...
      <div class="flex items-center w-full mx-5  border-2 border-l-0 border-t-0 border-b-0">
        ...
        <div>
          <p class="font-semibold py-4 text-cloudenly-success-mid text-xl">
           25%
          </p>
          <p class="text-lg">Promo Rate</p>
        </div>
      </div>
      <div class="flex items-center w-full mx-5 border-2 border-l-0 border-t-0 border-b-0">
        ...
        <div>
          <p class="font-semibold py-4  text-red-500 text-xl">
           12-02-2022
          </p>
          <p class="text-lg">Starts (DateTime)</p>
        </div>
      </div>
      <div class="flex items-center w-full mx-5 border-none">
        ...
        <div>
          <p class="font-semibold text-grey-dark py-4 text-xl">
           14-02-2022
          </p>
          <p class="text-lg">End (DateTime)</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white py-8 mt-8">
      <div class=" flex justify-between">
        <label class="flex items-center ml-4">
          <s-select class="" width="300" />
          <s-select class="ml-4" width="300" />
          <s-text type="date" class="ml-8" />
          <s-text type="date" class="ml-8" />
        </label>
        <div>
          <div class="flex">
    ...
    <div class="mt-5">
      <div class="bg-white">
        ...
        <div class="bg-white mx-auto mt-5">
          <div class>
            <table
            ...
            >
              <thead class="bg-gray-300">
                <tr class>
                  <th class="py-3 px-4 tracking-wider font-semibold">
                    Item Name
                  </th>
                  <th class="py-3 text-center tracking-wider font-semibold">
                    Promo Quantity
                  </th>
                  <th class="py-3 text-center tracking-wider font-semibold">
                    Quantity Sold
              ...
              <tbody v-for="n in 3" :key="n">
                <td class="py-3 px-4">Health day discount</td>
                <td class="py-3 text-center">20</td>
                <td class="py-3 text-center">20</td>
                <td class="py-3 text-center">N250,000</td>
