<template>
  <div>
    ...
    <div v-if="getIsAccOwner || getPromotionPrivileges.updatePromotion ">  
      <back location="Edit Promotion" class="mb-8" />
      ...
      <div class="bg-white px-6 pt-8 pb-10 rounded">
        ...
        <div class="grid grid-cols-12 col-gap-16">
        ...
        <div class="flex justify-between">
          ...
          <div class="flex items-center">
            ...
            <!-- <button
              class="px-6 py-4 bg-primary-optima-color flex items-center rounded-full"
              style=" color: #f3f6f9"
...
export default {
 ...
 outlets(){
  ...
  mounted() {
    ...
    // console.log(id);
    this.$store
      .dispatch("crm/promotions/getSinglePromotion", id)
      .then((resp) => {
        // console.log(resp.data);
