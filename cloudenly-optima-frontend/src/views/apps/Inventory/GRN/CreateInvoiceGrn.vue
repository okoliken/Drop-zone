<template>
  <div class="">
    <back location="Good Received Note - Generate" class="mb-8" />
    ...
    <Drawer :size="50" :visible="grnDrawer" v-on:closeDrawer="close">
      <div slot="title">
...
export default {
  ...
  mounted() {
    ...
    this.$store
      ...
      .then((resp) => {
        // console.log(resp.data);
        this.grnData.receiptNumber = resp.data.invoice.invoiceNumber;
        this.grnData.originObject = "invoice";
        this.grnData.originId = resp.data.invoice.id;
        this.grnData.currency = resp.data.invoice.currency;
        this.grnData.date = resp.data.invoice.date;
        this.grnData.description = resp.data.invoice.comment;
        this.grnData.goodsReceivedNoteBoqs = resp.data.invoice.invoiceBoqs.map(
          (resp) => {
            return {
        ...
        this.grnData.supplier = {
          ...
          contactName: resp.data.senderInfo.name,
