                  ...
                  <tr v-for="(invoice,index) in allRequestion " :key="index">
                    <td scope="row">{{index+1}}</td>
                        ...
                        <td> <Badge dot>
                          ...
                          <td class="text-center"> <button @click="routeEditPr(invoice.id)" class=" btn btn-sm btn-primary"> Generate GRN</button> </td>   
                  ...
                  <div v-show="showLoading">  
                   ...
                   <div  v-show="showAlert">
                       ...
                       <Alert type="error" show-icon>
                           <h4>
                                You dont have any Purchase Invoice yet! 
                           </h4>
                            <span slot="desc">   </span>
                        </Alert>
                   </div>
