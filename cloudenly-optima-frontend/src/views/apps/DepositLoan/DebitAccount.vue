 ...
 <div class="ks-page-header">
  ...
  <section class="ks-title">
    ...
    <div class="ks-body">
            ...
            <div class="card panel panel-default ks-bg-light-gray ks-solid">
                <div class="card-block">
                    <div class="payment-simple-amount-item-description">
                      <h5>
                    Debit Total Amount <span class="ks-progress-type">: </span>
                      </h5>
                    </div>
                </div>
            </div>
         ...
         <div class="col-lg-4">
          <div class="card panel panel-default ks-bg-light-gray ks-solid">
                <div class="card-block">
                    <div class="payment-simple-amount-item-description">
                      <h5>
                      Invoice Payables <span class="ks-progress-type">:</span>
                      </h5>
                    </div>
                </div>
            </div>
     ...
     <div class="container">
      <Tabs :animated="false">
        <TabPane label="Invoice Payables">
            <div class="panel">
              <br>
              <div class="container">
                <div class="row">
              ...
              <table class="table table-bordered table-striped  table-hover">
                ...
                <tbody>
                <template>
                  <tr v-for="(invoice,index) in accountRecievables.invoiceReceivable " :key="index">
         ...
         <TabPane label=" Credit Note">
             <div class="panel">
              ...
              <table class="table table-bordered table-striped  table-hover">
                ...
                <tbody>
                  <template>
                    <tr v-for="(debitNote,index) in accountRecievables.debitNoteReceivable " :key="index">
        ...
        <TabPane label="Deposit Account">
            <div class="panel">
              ...
              <table class="table table-bordered table-striped  table-hover">
                ...
                <tbody>
                <template>
                  <!-- <tr v-for="(invoice,index) in accountRecievables " :key="index">
                        <td class=" text-center">{{invoice.customer.name}}</td>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.$axios.get(`${this.$apiCloudenly}account-payable-and-receivable/payables/${this.userData.businessId}/${this.userData.businessId}`, this.$simpleAuthHeader)
        .then(resp => {
          console.log(resp.data);
          this.accountRecievables = resp.data;
        })
        .catch(err => {
          console.log(err);
        });
