		...
		<vs-sidebar click-not-close parent="#email-app-container" :hidden-background="true" class="full-vs-sidebar email-view-sidebar" v-model="isSidebarActive" position-right>
			<div class="mail-sidebar-content px-0 sm:py-6 pt-2 h-full" v-if="currentMail">
					...
					<div class="ml-10 mb-4 mt-1">
						<div class="email__actions--single flex items-baseline">
							...
							<vs-dropdown vs-custom-content vs-trigger-click>
								<feather-icon icon="FolderIcon" svg-classes="h-6 w-6" class="cursor-pointer ml-4"></feather-icon>
								<vs-dropdown-menu>
									<ul class="my-2">
				...
				<div v-if="isSidebarActive">
					...
					<!-- ALL MESSAGES - THREAD -->
					<div class="vx-row" v-for="threadMail in currentMail.replies.slice().reverse()" :key="threadMail.id">
						<div class="vx-col w-full">
							<vx-card class="px-4 mb-10">

								<!-- MAIL META ROW -->
								<div class="vx-row">
									<div class="vx-col w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid  justify-between flex items-center">
										<div class="flex items-center">
					...
					<div class="vx-row">
						<div class="vx-col w-full">
							<vx-card class="px-4">
								...
								<!-- MAIL META ROW -->
								<div class="vx-row w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid justify-between flex items-center">
