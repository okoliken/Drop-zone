	...
	<div id="email-app">
		...
		<div class="content-area__content">
			<div id="email-app-container" class="border border-solid border-grey-light rounded relative overflow-hidden">
					...
					<vs-sidebar class="items-no-padding reduced-vsidebar" parent="#email-app-container" :click-not-close="clickNotClose" :hidden-background="clickNotClose" v-model="isEmailSidebarActive">
						<email-sidebar :emailTags="emailTags" @closeSidebar="toggleEmailSidebar" :mailFilter="mailFilter"></email-sidebar>
					</vs-sidebar>

					<div :class="{'sidebar-spacer-small': clickNotClose}" class="app-fixed-height border border-solid border-grey-light border-r-0 border-t-0 border-b-0">
