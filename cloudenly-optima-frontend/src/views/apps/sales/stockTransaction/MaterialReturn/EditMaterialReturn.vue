  ...
  <div class="mb-12">
      ...
      <form data-vv-scope="form-2" action="">
        <div class="">
          <div class=" mr-10">
            <div class="vx-row mb-6" :class="{error:errors.has('form-2.name')}">
              ...
              <div class="vx-col sm:w-2/3 w-full">
                <vs-input name="name" v-validate="'required'" v-model="network.name" class="w-full" />
                <div class="error text-cloudenly-danger-main" v-if="errors.has('form-2.name')">
            ...
            <div class="vx-row mb-6" :class="{error:errors.has('form-2.email')}">
              ...
              <div class="vx-col sm:w-2/3 w-full">
                ...
                <vs-input name="email" class="w-full" v-validate="'required|email'" v-model="network.email" />
                <div class="error text-cloudenly-danger-main" v-if="errors.has('form-2.email')">
            ...
            <div class="vx-row mb-6" :class="{error:errors.has('form-2.phone')}">
              ...
              <div class="vx-col sm:w-2/3 w-full">
                ...
                <vs-input name="phone" class="w-full" v-validate="'required'" v-model="network.phoneNumber" />
                <div class="error text-cloudenly-danger-main" v-if="errors.has('form-2.phone')">
            ...
            <div class="vx-row mb-6" :class="{error:errors.has('form-2.price')}">
              <div class="md:w-1/3  text-right w-full ">
                Price Reference
              </div>
              <div class="vx-col sm:w-2/3 w-full">
                <select name="price" v-model="network.contactCategory"
                  class="block  w-full bg-gray-200 border
                        border-gray-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                  <option value="wholesale">Wholesale</option>
                  <option value="retail">Retail</option>
                </select>
                <div class="error text-cloudenly-danger-main" v-if="errors.has('form-2.price')">
            ...
            <div class="vx-row mb-6" :class="{error:errors.has('form-2.loyalty')}">
              ...
              <div class="vx-col sm:w-2/3 w-full">
                ...
                <select name="loyalty" v-model="network.loyaltySchemeId"
                  ...
                  id="grid-state">
                  <option v-for="(loyalty, index) in allLoyalty" :key="index" :value="loyalty.id">
                    {{loyalty.loyaltyCategory}}</option>
                  <option value="null"> None</option>
                </select>
                <div class="error text-cloudenly-danger-main" v-if="errors.has('form-2.loyalty')">
          ...
          <div class="flex items-center justify-center">
            <button :disabled="saveCustomerButton"
              :class="{'cursor-not-allowed': saveCustomerButton, 'bg-cloudenly-primary-mid' : saveCustomerButton}"
              type="button" @click="saveNewCustomer('form-2')" class="px-10 py-3 border-none cursor-pointer 
                 bg-cloudenly-primary-main text-white rounded">Save </button>

            <button type="button" @click="customerModal = false"
              class="px-10 py-3 border-none cursor-pointer bg-transparent  rounded">Cancel
            </button>
          </div>
        </div>
    ...
    <div class="px-5 py-8 bg-white shadow rounded ">
        ...
        <div class="col-8">
          <div>
            ...
            <div class=" flex items-center  w-full">
              <select v-model="materialReturnData.contact" name=""
                class=" py-4 px-2 rounded  w-2/3 mr-5  border border-solid border-grey-light " id="">
                <option v-for="(customer, index) in allContact" :key="index" :value="customer"> {{customer.name}}</option>
              </select> 

              <div>
                <button @click="customerModal=true" class=" py-3 px-10 bg-cloudenly-primary-main border-none text-white rounded cursor-pointer"> New Customer</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-4">
          <div>
            ...
            <div class="form-group row no-gutters">
              <div class="w-full ">
                <input v-model="materialReturnData.title"
                  class=" py-4 px-3 rounded border border-solid border-grey-light w-full" type="text" name="" id="">
      ...
      <div class="row no-gutter mb-5">
        ...
        <div class="col-4">
          <div class="">
            <label class="block md:text-left mb-1 md:mb-0 text-sm  font-bold" for="inline-full-name">Store Manager</label>
            <div class=" ">
              <input v-model="materialReturnData.storeManager" type="text"
                class=" py-3 px-2 rounded w-full  border border-solid border-grey-light" name="" id="">
            </div>
          </div>
        </div>
        ...
        <div class="col-4">
          ...
          <div class="">
            <label class="block md:text-left mb-1 md:mb-0 text-sm  font-bold" for="inline-full-name">
              Department</label>
            <div class=" ">
              <input v-model="materialReturnData.requesterDepartment" type="text"
                class="py-3 px-2 rounded w-full  border border-solid border-grey-light" name="" id="">
            </div>
          </div>
        </div>
        ...
        <div class="col-4">
           ...
           <div class="">
                <label class="block md:text-left mb-1 md:mb-0 text-sm  font-bold" for="inline-full-name">
                  Date</label>
                <div class=" ">
                  <datepicker v-model="materialReturnData.dateOfReturn" input-class="w-full py-3"
      ...
      <div class="row no-gutter">
        ...
        <div class="col-4">
          ...
          <div class="form-group row no-gutters">
            <div class="col-md-12">
              <textarea v-model="materialReturnData.description" rows="4" cols="30" class="form-control"
        ...
        <div class="col-4">
          <label class="block md:text-left mb-1 md:mb-0 text-sm  font-bold" for="inline-full-name">Validity
            Period</label>
          <div class="flex items-center w-full">

            <div class=" w-2/3 mr-2">
              <input type="text" v-model="materialReturnData.validityDur" class=" py-3 px-3  rounded border border-solid border-grey-light w-full" name="" id="">
            </div>
            <div class="w-1/3 ">
              <select class="  py-3 px-3 rounded border border-solid border-grey-light w-full" placeholder="Select Category"
    ...
    <section class="pb-10">
        ...
        <table class="table w-full table-auto table-responsive ">
          ...
          <tbody>
            <tr v-for="(material, index) in  materialReturnData.materialReturnBoqs" :key="index">
              <td class="w-1/4">
                <input disabled class=" form-control " v-model="material.variantName" name="" id="" />
              </td>
              <td>
                <input disabled class=" form-control " v-model="material.description" name="" id="" />
              </td>
              <td>
                <input disabled class=" form-control" v-model="material.variantCode" name="" id="" />
              </td>
              <td>
                <input disabled class=" form-control" v-model="material.unitOfMeasure" name="" id="" />
              </td>



              <td>
                <input v-model="material.quantityReturned" class="form-control " placeholder="Enter Quantity" />
      ...
      <div class="float-right mt-10 mb-10">
          ...
          <button @click="updateMaterialReturn"
           :disabled="updateButton" :class="{'cursor-not-allowed': updateButton, 'bg-cloudenly-primary-mid' : updateButton}"
            class="inline-flex items-center     
              border-0 py-3 px-10  mr-3 cursor-pointer bg-cloudenly-primary-main text-white  border border-solid rounded-lg  border-cloudenly-primary-mid">
        ...
        <!-- <vs-dropdown vs-custom-content vs-trigger-click>
          <button
            class="inline-flex items-center     
                         border-0 py-2 px-5  mr-3 cursor-pointer bg-cloudenly-primary-main text-white  border border-solid rounded-lg  border-cloudenly-primary-mid">
          ...
          <vs-dropdown-menu>
            <ul style="min-width: 20rem">
              ...
              <li @click.prevent="saveMaterialReturn"
                class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white">
                <feather-icon icon="CheckSquareIcon" svgClasses="w-4 h-4"></feather-icon> <span class="ml-2">Save Request</span>
              </li>
...
export default {
  ...
  methods: {
      ...
      this.materialReturnData.materialReturnBoqs.push(
        {
         ...
         unitOfSale: val.retailPriceBook.unitOfSale,
         quantityReturned: 0
      })
    },
    ...
    updateMaterialReturn() {
      ...
      this.materialReturnData.contact = {
          ...
          email: this.materialReturnData.contact.email,
          contactName: this.materialReturnData.contact.contactName,
          phoneNumber: this.materialReturnData.contact.phoneNumber	
      }
      let data = {
        userInfo: userInfo,
      ...
      this.$store.dispatch('inventory/materialReturn/updateMaterialReturn', data).then(resp => {
     ...
     saveNewCustomer(scope) {
      this.$validator.validateAll(scope).then(resp => {
        if (resp) {
          ...
          this.$store.dispatch("crm/contact/createNewContact", dataPayload).then(resp => {
            this.$vs.notify({
              title: 'Contact',
              text: resp.data.message,
              color: 'primary',
  ...
  computed: {
   ...
   mounted() {
    ...
    this.$store.dispatch('inventory/materialReturn/getSingleMaterialReturn', id).then(resp => {
