        ...
        <div>
          <div class>
            ...
            <div>
              ...
              <div
                class="mb-8 mx-16 ml-16 border border-solid border-grey-lighter rounded-lg"
              >
                <div class="p-3">
...
export default {
  ...
  methods: {
          ...
          this.creditNoteData.invoiceShippingChargeTaxes = this.allVat.taxes.map(
            (resp) => {
              return {
                ...
                rate: resp.amount,
                amount:
                  (Number(resp.amount) * this.creditNoteData.shippingCharge) /
                  100,
              };
            }
          );
    ...
    calTaxSpecialDiscount() {
      let specialDiscountTaxPolicy = this.creditNoteData
        .specialDiscountTaxPolicy;
