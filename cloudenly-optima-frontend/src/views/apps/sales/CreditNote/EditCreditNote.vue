          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-6">
                  <DatePicker v-model="creditNoteData.date"></DatePicker>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-6">
                  <select
                    class="form-control"
                    v-model="creditNoteData.reasonForNote"
                  >
              ...
              <div class="form-group row">
                ...
                <div class="col-6">
                  <textarea
                    class="form-control"
                    v-model="creditNoteData.noteDescription"
                    name=""
                    id=""
                    cols="30"
                    rows="3"
            ...
            <tbody class="">
              ...
              <tr>
                ...
                <th style="width: 20%">
                  <input
                    type="text"
                    class="form-control"
                    v-model="creditNoteData.globalDiscountRate"
                    name=""
                    id=""
                  />
                </th>
                <th style="width: 30%">{{ creditNoteData.globalDiscount }}</th>
              </tr>
              <tr>
                <th style="width: 50%">
                ...
                <th style="width: 20%"></th>
                <th style="width: 30%">
                  {{ creditNoteData.discountedSubTotal }}
                </th>
              </tr>
              ...
              <tr>
                ...
                <th style="width: 20%">
                  <input
                    type="text"
                    v-model="creditNoteData.vatRate"
                    class="form-control"
                  />
                </th>
                <th style="width: 30%">{{ creditNoteData.vat }}</th>
              </tr>
              ...
              <tr>
                ...
                <th style="width: 20%"></th>
                <th style="width: 30%">{{ creditNoteData.grandTotal }}</th>
              </tr>
            </tbody>
          </table>
        </div>
...
export default {
  ...
  methods: {
    ...
    deleteNewSale(val, index) {
      ...
      this.creditNoteData.newSales.splice(index, 1);
    },
    addCustomer(val) {
      this.custSearchTriggered = false;
      this.customerCard = true;
      this.singleCustomer = val;
      this.creditNoteData.networkHash = val.hash;
      // $("#myModal").modal("hide");
    },
    ...
    sendDebitNote() {
      ...
      delete this.creditNoteData.productBoqs;
      delete this.creditNoteData.serviceBoqs;
      this.$axios
        .patch(
          `${this.$apiCloudenly}credit-debit-note/update/${this.creditNoteData.hash}`,
          this.creditNoteData,
        ...
        .then((resp) => {
          if (resp.data) {
            const data = {
              title: this.creditNoteData.description,
              business: this.businessData.name,
              total: this.creditNoteData.grandTotal,
              noteHash: resp.data.hash,
              email: this.singleCustomer.email,
            };
            this.$axios
              .post(
                this.$apiCloudenly + "credit-debit-note/send/credit",
                data,
                this.$simpleAuthHeader
              )
              .then((resp) => {
                ...
                this.$router.push({ name: "CreditNoteList" });
              })
              .catch((err) => {
                console.log(err);
              });
  ...
  watch: {
    "creditNoteData.subTotal": function () {
      this.creditNoteData.globalDiscount =
        (parseInt(this.creditNoteData.globalDiscountRate || 0) *
          parseInt(this.creditNoteData.subTotal || 0)) /
        100;
      // console.log('This is the Global Discount', this.creditNoteData.globalDiscount)

      this.creditNoteData.discountedSubTotal =
        this.creditNoteData.subTotal - this.creditNoteData.globalDiscount;
      // console.log('discounted Total...', this.creditNoteData.discountedSubTotal)

      this.creditNoteData.vat =
        (parseInt(this.creditNoteData.vatRate || 0) *
          parseInt(this.creditNoteData.discountedSubTotal || 0)) /
        100;
      //  console.log('This is the Vat Amount', this.creditNoteData.vat)

      this.creditNoteData.grandTotal =
        parseInt(this.creditNoteData.vat) +
        parseInt(this.creditNoteData.discountedSubTotal);
      // console.log('This is the grand Total', this.creditNoteData.grandTotal)
    },

    "creditNoteData.globalDiscountRate": function () {
      this.creditNoteData.globalDiscount =
        (parseInt(this.creditNoteData.globalDiscountRate || 0) *
          parseInt(this.creditNoteData.subTotal || 0)) /
        100;
    ...
    "creditNoteData.vatRate": function () {
      this.creditNoteData.globalDiscount =
        (parseInt(this.creditNoteData.globalDiscountRate || 0) *
          parseInt(this.creditNoteData.subTotal || 0)) /
        100;
  ...
  computed: {
    ...
    purchaseSubTotal() {
      ...
      return (this.creditNoteData.subTotal = parseInt(
    ...
    //   }
    //   return (this.creditNoteData.serviceSubTotal = total);
    // }
  },
  ...
  mounted() {
    ...
    this.creditNoteData.owner = userData.owner;
    this.creditNoteData.creator = userData.scellooId;
    this.creditNoteData.business = businessData.businessId;
    this.creditNoteData.outlet = userData.businessId;
    ...
    this.$axios
      ...
      .then((resp) => {
        ...
        this.creditNoteData.networkHash = resp.data.network.hash;
