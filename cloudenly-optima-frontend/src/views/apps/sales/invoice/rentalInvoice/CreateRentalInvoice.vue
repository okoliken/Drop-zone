...
<template>
  <div class>
    <back location="Create Rental Invoice" />
    ...
    <div v-if="getIsAccOwner || getSalesInvoicePrivileges.createInvoice">
      <div class="px-5 py-10 mt-5 bg-white shadow rounded">
        <p class="font-bold text-dark-optima-color">Create Rental Invoice</p>
        ...
        <div v-show="invoiceData.recurringInvoice" class="flex items-center mt-3">
          <div class="mr-3">
             <div class=" mb-3">
          ...
          <div>
            ...
            <select
              ...
              class="w-full py-2 border border-solid rounded"
              name
              id
            >
