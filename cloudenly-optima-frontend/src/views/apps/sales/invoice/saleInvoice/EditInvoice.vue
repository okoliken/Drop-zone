...
<template>
  <div class>
    ...
    <div v-if="getIsAccOwner || getSalesInvoicePrivileges.editInvoice">
...
export default {
  ...
  methods: {
    ...
    updateInvoice() {
      ...
      this.$store
        .dispatch("sales/Invoice/updateInvoice", data)
        .then((resp) => {
