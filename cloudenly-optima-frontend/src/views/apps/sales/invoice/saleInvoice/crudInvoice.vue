s/* eslint-disable vue/no-side-effects-in-computed-properties */ /*
eslint-disable no-case-declarations */ /* eslint-disable no-case-declarations */
<template>
  <div>
    <back location="Invoice - New" />
    ...
    >
      <div class="container">
        ...
        >
          <div class="flex items-center mx-1">
            <!-- <div class="mr-5 cursor-pointer z-10" v-my-tooltip.top-start="'Kindly fill up the details below to create a new PR'">
              <feather-icon
                svgClasses="text-cloudenly-primary-main"
                class="h-8 w-8"
                icon="InfoIcon"
    ...
    <div v-if="getIsAccOwner || getSalesInvoicePrivileges.createInvoice">
      <div class="px-5 py-10 mt-5 bg-white shadow rounded">
       
        <div class="flex items-center justify-between mb-10">
             <p class="font-bold text-dark-optima-color">Create New Invoice</p>
            <div v-my-tooltip.top-start="'Kindly fill up the details below to create new Invoice'">
               <feather-icon
              icon="AlertCircleIcon"
          ...
          <div class="col-4 w-1/3 mr-8">
            <div class>
              ...
              <select
                ...
                name
                id
                class="px-2 py-2 border-gray-400 border-1 rounded w-full"
              >
                <option
          ...
          <div class="col-4 w-1/3">
            <div class="mb-5">
              <div class="w-full">
                <div class="mb-5">
                  <label
                    class="block md:text-left text-sm"
        ...
        <div class="row flex mt-8">
            ...
            <div class>
              ...
              <div class="md:w-full flex">
                <select
                  ...
                  class="w-1/3 py-1 border border-1 border-gray-400 px-2"
                >
                ...
                <input
                  type="text"
                  class="w-full py-2 border border-1 border-gray-400 px-2 mr-1"
          ...
          <div class="col-4 w-1/3">
            ...
            <textarea
              ...
              class="py-2 px-2 border border-1 border-gray-400 rounded w-full"
              name
              id
              cols="30"
              rows="3"
        ...
        <!-- auto recurring section -->
        <div
          class="col-6 py-5 mt-5 border border-solid border-gray-400-lighter"
        >
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                class="w-full py-2 border border-1 border-gray-400 rounded"
                name
                id
              >
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      >
                        ...
                        type="text"
                        class="py-3 px-2 border border-1 border-gray-400 w-full rounded"
                      /> -->
                      ...
                      <td>
                        <select
                          ...
                          v-model="boq.accountId"
                        >
                          <option
                            v-for="boq in getAccListFromExpOrRevCostCentre"
                            value="boq.id"
                            :key="boq.id"
                          >
                            {{ boq.accountName }}
                  ...
                  <!-- <tr>
                    ...
                    <td class="px-6 py-3 whitespace-no-wrap">
                      <input
                        ...
                        class="py-2 px-2 mr-8 border border-gray-400 border-1 rounded"
                      />
                    </td>
                    <td class="px-6 py-3 whitespace-no-wrap">
                      <button
                    ...
                    <td class="px-6 py-3 whitespace-no-wrap">
                      <label class="flex items-center font-normal" for>
                        ...
                        <span class="font-normal"
                          >Add Delivery & Other Charges</span
                        ></label
                      >
                    </td>
                    <td class="px-6 py-3 whitespace-no-wrap">
                ...
                <table class="table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="px-6 py-3 whitespace-no-wrap">
                        <span class="tracking-widest">{{
                          invoiceData.shippingCharge | currency
                        }}</span>
                      </td>
                      <td class="px-6 py-3 whitespace-no-wrap"></td>
                    </tr>
                     ...
                     <tr>
                      ...
                      <td class="px-6 py-3 whitespace-no-wrap">
                        <span class="tracking-widest">{{
                          invoiceData.specialDiscount | currency
                        }}</span>
                      </td>
                      <td class="px-6 py-3 whitespace-no-wrap"></td>
                    </tr>
...
export default {
  ...
  methods: {
        ...
        if (val.hasOwnProperty("retailPriceBooks")) {
          ...
          if (type === "promoPrice") {
            this.selectedItem.push({
              ...
              functionOrGroupId:
                this.$store.state.auth.auth.userData?.functionId,
    ...
    selectCustomer() {
      ...
      this.selectedItem = [];
      this.invoiceData.billingAddress = this.selectedCustomer.address;
    ...
    getSubAccount() {
      this.invoiceData.subAccountCode =
  ...
  async mounted() {
    ...
    await this.$store.dispatch(
      "accounting/settings/getAccListFromExpOrRevCostCentre", "revenue");
    this.getSubAccount();
  },
};
</script>
