...
<template>
  <div class>
    <back location="Create Recurring Invoice" />
    ...
    <div v-if="getIsAccOwner || getSalesInvoicePrivileges.createInvoice">
      <div class="px-5 py-10 mt-5 bg-white shadow rounded">
        <p class="font-bold text-dark-optima-color">Create Recurring Invoice</p>
          ...
          <div class="col-4 w-1/3 mr-8">
            <div class>
              ...
              <select
                ...
                name
                id
                class="px-2 py-2 border-gray-400 border-2 rounded w-full"
              >
                <option
            ...
            <div class>
              ...
              <div class="md:w-full flex">
                <select
                  ...
                  class="w-1/3 py-1 border border-2 border-gray-400 px-2"
                >
                ...
                <input
                  type="text"
                  class="w-full py-2 border border-2 border-gray-400 px-2 mr-1"
        ...
        <div class="col-6 py-5 mt-5 border border-solid border-grey-lighter">
          <div class="flex items-center w-full mb-5">
            <p class="font-bold mr-5">invoice auto-recurring</p>
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                class="w-full py-2 border border-2 border-gray-400 rounded"
                name
                id
              >
          ...
          <section>
            ...
            <div class="p-10 flex justify-end">
              <div class="row">
                <div class="px-8">
                  <div
                    class="md:flex md:items-center mb-5 items-center"
                    v-for="(vat, index) in calTotalTaxPolicy"
                    :key="index"
                  >
                    <div class="md:w-1/2">
                      <label
                        class="block md:text-right pr-3 text-cloudenly-primary-main"
                        for="inline-full-name"
                      >{{vat.name}}</label>
                    </div>
                    <div class="md:w-1/2">
                      <span>{{vat.amount | currency}}</span>
                    </div>
                  </div>
                  ...
                  <div class="md:flex md:items-center mb-5 items-center">
                    ...
                    <div class="md:w-1/2">
                      <span>{{calTotalSalesTax | currency}}</span>
                    </div>
                  </div>
                  ...
                  <div class="md:flex md:items-center mb-5 items-center">
                    ...
                    <div class="md:w-1/2">
                      <span>{{calSalesInvoiceTotal | currency}}</span>
                    </div>
                  </div>
                  ...
                  <div class="md:flex md:items-center mb-5 items-center">
                    ...
                    <div class="md:w-1/2">
                      <span>{{calTotalCustomerDiscount | currency}}</span>
                    </div>
                  </div>
                </div>
              </div>
