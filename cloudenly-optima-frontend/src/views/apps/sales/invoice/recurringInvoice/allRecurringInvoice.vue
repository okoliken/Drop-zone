  ...
  <div>
    ...
    <div class="py-8 px-5 bg-white">
      ...
      <div class="flex items-center justify-end">
        <button
          type="button"
          @click="routeCreateRecurringInvoice"
          class="
            hover:text-white
            inline-flex
            items-center
    ...
    <div v-if="getIsAccOwner || getSalesInvoicePrivileges.viewInvoiceRegister">
      <div class="mt-2 bg-white">
        <div v-if="getIsRecurringInvoice">
          <table class="table min-w-full">
            ...
            <tbody>
              <template>
                <tr
                  v-for="(invoice, index) in getRecurringInvoice"
                  :key="index"
                >
                  <td
                    class="
                  ...
                  >
                    <vs-dropdown vs-custom-content vs-trigger-click>
                      ...
                      <vs-dropdown-menu v-if="invoice.status === 'draft'">
                          ...
                          <ul style="min-width: 12rem">
                            ...
                            >
                             ...
                             <li
                              ...
                              "
                            >
                              <span @click="viewReceipt(invoice.id)"
                              >Preview</span>
                            </li>
                            <!-- <li
        ...
        >
          <div class="flex items-center">
            <p class="mr-2">Show :</p>
            <select name class="py-1 mr-2 border-2 border-gray-400" id>
...
export default {
  ...
  computed: {
    ...mapGetters("sales/Invoice", [
      "getRecurringInvoice",
      "getIsRecurringInvoice",
    ]),
  ...
  mounted() {
    this.$store.dispatch("sales/Invoice/getAllRecurringInvoice");
  },
};
</script>
