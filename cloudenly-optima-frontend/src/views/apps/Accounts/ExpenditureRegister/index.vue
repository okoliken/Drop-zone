<template>
  <div>
    ...
    <div class="flex items-center bg-white p-8 justify-between space-x-6 mb-12">
      ...
      <div class="flex items-center  text-cloudenly-primary-main justify-between" @click="$router.push({ name: 'settingsHome' })">
    ...
    <div id="div-with-loading" class="vs-con-loading__container bg-white">
      ...
      <s-table :headers="headers" :items="getAllExpenditureRegister">
        <div slot="title">
          <p class="text-xl font-bold">Expenditure Register</p>
        </div>
        <div slot="body">
...
export default {
  ...
  computed: {
    ...mapGetters("accounting/settings/", ["getAllExpenditureRegister"]),
  },
