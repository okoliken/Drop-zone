<template>
  <div>
      ...
      <div class="flex items-center justify-between mt-3">
        <div class="flex items-center">
          ...
          <div class="flex items-center ml-10">
            <select class="field ml-5">
              <option value="" selected>--Revenue. Item--</option>
            </select>
          </div>
          <div class="flex items-center ml-10">
            <select class="field ml-5">
              <option value="" selected>--Revenue Category--</option>
            </select>
          </div>
        </div>
        ...
        <button
          ...
          @click="$router.push({ name: 'NewRevenueCostCentresAccounts' })"
        >
          <feather-icon
            icon="PlusIcon"
    ...
    <s-table :headers="headers" :items="filteredRevCostCentre">
      <div slot="title">
        <p class="text-xl font-bold">Revenue, CostCentres & Accounts</p>
      </div>
      <div slot="body">
        <p>This is Revenue, CostCentres & Accounts</p>
      </div>
...
export default {
  name: "RevenueCostCentresAccounts",
  components: {
    EmptyState,
  },
  ...
  computed: {
    ...mapGetters("accounting/settings/", ["getAllRevenueCostCenterAccount"]),

     ...mapGetters("accounting/settings/", ['getAllRevenueCostCenterAccount']),
    filteredRevCostCentre(){
       return this.getAllRevenueCostCenterAccount.filter((RevCostCentre) => {
        return RevCostCentre.costCentreName.toLowerCase().includes(this.search.toLowerCase());
      });
    },
  },
