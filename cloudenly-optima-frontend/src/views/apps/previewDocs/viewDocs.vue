    ...
    <div class="bg-white px-12">
      <div class="bg-x flex">
        <div
          ...
          "
        >
          <img id="receipt-user-logo" :src="getOrgData.logoUrl" alt="logo" />
        </div>
        <div class="invoice-header flex-1 ml-12">
          <div class="grid grid-cols-3 gap-4 mt-10">
            <div class="g-item">
              ...
              <span
                class="block py-2 text-lg font-normal text-dark-optima-color"
              >
                Registered Business No: {{ getOrgData.rcNumber }}
              </span>
            </div>
            <div class="g-item">
              <span class="block p-1 mt-5 ml-10 text-lg font-normal text-dark-optima-color">
                <template v-if="type != 'waybill'">
                  {{ getOrgData.profile }}</template
                >
                <template v-if="type == 'waybill'">
                  {{ data.waybill.orgInfo.address | value }}
                  </template
                >
              </span>
            </div>
            <div class="g-item">
              ...
              <span
                class="block p-1 text-lg font-normal text-dark-optima-color"
              >
          ...
          <div class="grid grid-cols-3 gap-1 my-2">
            <span class="text-base text-gray-600">
              ...
              <template v-if="type == 'waybill'">
                <span class="text-base text-gray-600">Waybill Number:</span>
                <span class="font-bold text-dark-optima-color">
              ...
              <template v-if="type == 'purchaseorder'"
                ><span class="text-base text-gray-600">PO Number:</span>
                <span class="font-bold text-base text-dark-optima-color">
            ...
            <span class="text-base text-gray-600" v-if="type == 'waybill'"
              >Reference No:
              <span class="font-bold text-dark-optima-color">
            ...
            <span class="text-base text-gray-600"
              > 
              <span class="ml-8">Date Issued:</span> 
              <span class="font-bold mx-4 text-dark-optima-color">
                <template
                  v-if="
                    type == 'invoice' ||
                    type == 'quote' ||
            ...
            <span class="text-lg text-gray-600" v-if="type == 'purchaseorder'"
              >Exp Delivery Date:
              <span class="font-bold text-dark-optima-color">
      ...
      <div class="flex mt-16" v-if="type == 'waybill'">
        <div class="flex-1 text-left">
          <span class="text-lg font-bold text-gray-500 py-4 block">
            <span
              v-if="
                type == 'invoice' || type == 'purchaseorder' || type == 'quote' || type == 'waybill'
              "
              >Billed To:</span
            >
          ...
          <span class="text-xl text-dark-optima-color block py-2">
            ...
            <template v-if="type == 'purchaseorder' || type == 'waybill'">
        ...
        >
          ...
          >
            <span class="text-gray-500 text-lg font-extrabold mr-2">
              {{
                type == "invoice"
                  ? "Invoice Currency"
                  : type == "creditnote"
      ...
      <table class="table-fixed mt-3" style="width: 100%">
        <thead>
          <tr class="invoice-table-header">
            <th
              class="
                ...
                font-extrabold
                py-4
                text-3xl text-dark-optima-color text-center
              "
            >
              #
            </th>
            <th
              class="w-1/3 font-extrabold py-4 text-xl text-dark-optima-color"
            >
        ...
        <tbody>
          ...
          >
            ...
            >
              ...
              <template v-if="type == 'purchaseorder' || type == 'purchaseorder'">
      ...
      <div
        class="invoice-total-wrapper py-6"
        v-if="type != 'waybill' && type != 'purchaseRequisition'"
      >
        <span
      ...
      <div class="flex mt-32">
        ...
        <div v-if="type == 'waybill' || type != 'purchaseRequisition'">
              ...
              <tr>
                ...
                <td>
                  <span class="text-dark-optima-color text-xl font-extrabold">
                    <template v-if="type == 'invoice' || type == 'quote' || type == 'waybill'">
          ...
          >
            <span
              class="text-light-optima-color text-2xl mr-5 block font-extrabold"
              >Grand Total:</span
            >
            <span
              class="
            ...
            >
              ...
              <template v-if="type == 'waybill'">
                {{ data.waybillTotal | currency }}</template
              >
            </span>
          </div>
