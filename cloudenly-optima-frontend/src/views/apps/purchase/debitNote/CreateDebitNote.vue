...
<template>
  <div class>
    ...
    <div class="flex items-center">
      ...
      <p class="ml-3 font-normal">Create Debit Note</p>
    </div>
    ...
    <vs-popup :button-close-hidden="true" title="Apply Promotion" :active.sync="promoModal">
      <div class="container">
        <div
    ...
    <vs-popup button-close-hidden :active.sync="processModal" title="Process Invoice">
      <div class="container">
        <div
          class="p-5 border border-solid rounded border-l-4 border-r-0 border-b-0 border-t-0 border-cloudenly-primary-main bg-white"
        >
            ...
            <div>
              <div class="mb-8">
                <div class>
                  <p
                    class="p-3 mb-0"
                  >Setup and Manage the code that will be generated when you create a Quote...</p>
              ...
              <div class="mb-8 mx-16 ml-16 border border-solid border-grey-lighter rounded-lg">
                ...
                <div class="flex justify-center">
                  <p class="text-lg font-medium text-cloudenly-warning-main">{{message}}</p>
                </div>
                ...
                <div class="flex items-center justify-center">
                  ...
                  <div id="div-with-loading-preview" class="py-3 vs-con-loading__container">
                    <span
                      class="px-3 py-5 my-5 border border-solid bg-grey-lighter font-bold text-xl border-grey"
    ...
    <div class="px-5 py-10 mt-5 bg-white shadow rounded">
      ...
      <div class="row mt-10">
        <div class="col-4">
          <div class>
            ...
            <select
              ...
              name
              id
              class="px-2 py-2 border border-gray-400 rounded w-full"
            >
              <option
        ...
        <div class="col-4">
          ...
          <div class="form-group row no-gutters">
            <div class="col-md-12">
              <textarea
                v-model="creditNoteData.billingAddress"
                rows="3"
                cols="30"
        ...
        <div class="col-4">
          ...
          <div class="form-group row no-gutters">
            <div class="col-md-12">
              <textarea
                v-model="creditNoteData.deliveryAddress"
                rows="3"
                cols="30"
                class="py-2 px-2 border border-gray-400 w-full rounded"
                placeholder="Enter Address"
      ...
      <div class="row mt-5">
        <div class="col-4">
          <div class="mb-5">
            <label class="block md:text-left" for="inline-full-name">Delivery Date</label>
          </div>
          <div class>
            <datepicker
              v-model="creditNoteData.deliveryDate"
        ...
        <div class="col-4">
          <div v-if="getIsInvoiceCodeSetup" class>
            <div class="mb-5">
              <label class="block" for="inline-full-name">Invoice No</label>
            </div>
            <div class="md:w-full">
              <input
                disabled
                v-model="creditNoteData.invoiceNumber"
                type="text"
          ...
          <div v-else>
            ...
            <div class="md:w-full">
              <input
                v-model="creditNoteData.invoiceNumber"
                type="text"
                class="w-full py-3 border border-solid border-grey px-2 rounded"
                name
                id
              />
        ...
        <div class="col-4">
          <div class="mb-5">
            <div class="w-full">
              <div class="mb-5">
                <label class="block md:text-left text-sm" for="inline-full-name">Sales Person</label>
              </div>
              <div class>
                <select
                  v-model="creditNoteData.salesPerson"
                  class="py-1 px-1 border border-solid border-grey rounded w-full"
                  name
                  id
                >
                  <option
      ...
      <div class="row mt-8">
        <div class="col-4">
          <div class>
            <div class="mb-5">
              <label class="block md:text-left" for="inline-full-name">Validity Period</label>
            </div>

            <div class="md:w-full flex">
              <select
                v-model="creditNoteData.validityType"
              ...
              <input
                type="text"
                class="w-full py-2 border border-solid border-gray-400 px-2 mr-1"
                placeholder="Enter Value"
                v-model="creditNoteData.validityDur"
                name
                id
              />
            </div>
        ...
        <div class="col-4">
          <div class>
            ...
            <div class="w-full">
              <select
                class="w-full py-1 border border-solid border-gray-400 px-2 rounded"
                v-model="creditNoteData.currency"
              >
                <option
        ...
        <div class="col-4">
          <div class="mb-5">
            <label class="block md:text-left text-sm" for="inline-full-name">Payment Terms</label>
          </div>

          <textarea
            v-model="creditNoteData.paymentTerms"
      ...
      <div class="pt-3">
        <section>
          ...
          <div id="div-with-loading" class="vs-con-loading__container mt-8">
            <div class="overflow-x-auto">
              <table style="width: 100%" class="table w-full mb-3">
                ...
                <tbody>
                  <tr v-for="(boq, index) in selectedItem" :key="index" class="mb-5">
                    <td class="px-3 text-center py-3 whitespace-no-wrap border-b border-gray-200">
                      <input
                        v-model="boq.name"
                        type="text"
                        class="py-3 px-2 border border-solid border-grey w-full rounded"
                      />
                    </td>
                    <td class="px-3 text-center py-3 whitespace-no-wrap border-b border-gray-200">
                      <input
                    ...
                    <td class="px-3 text-center py-3 whitespace-no-wrap border-b border-gray-200">
                      <vs-dropdown class="text-center" vs-custom-content vs-trigger-click>
                        <p
                          class="text-center center text-cloudenly-primary-main pl-5 flex cursor-pointer border border-solid py-3 ml-2 pr-5 rounded"
                        >{{boq.totalTax | formatCurrency}}</p>
                        <vs-dropdown-menu>
                          <ul style="min-width: 23rem">
                            ...
                            >
                              {{vat.name}} - {{vat.rate}}% :
                              <span
                                class="ml-5 text-cloudenly-warning-main"
                              >
                                Tax Amount =
                                {{vat.amount | currency}}
                              </span>
                  ...
                  <tr class="pt-3 mt-3 mb-5">
                    ...
                    <td
                      ...
                      style="width:10%"
                    >{{calTotalSubLineTotalDiscountAmount | currency}}</td>
                    <td
                      class="text-center leading-loose font-normal"
                      style="width:10%"
                    >{{calTotalSubLineTotalExcludingTax | currency}}</td>
                    <td
                      class="text-center leading-loose font-normal"
                      style="width: 10%"
                    >{{calTotalSubLineTotalTaxAmount | currency}}</td>
                    <td style="width:10%"></td>
          ...
          <div>
            <p class="mt-8">* Please note thesedddd settings will affect your item Bill of Quantity</p>
                  ...
                  <div class="flex items-center">
                    <div class="mr-5">
                      <input
                        ...
                        v-model="creditNoteData.shippingCharge"
                        type="text"
                    ...
                    <div>
                      <select
                        ...
                        v-model="creditNoteData.shippingChargeTaxPolicy"
                  ...
                  <div class="flex items-center">
                    <div class="mr-5">
                      <input
                        ...
                        v-model="creditNoteData.specialDiscount"
                        type="text"
                    ...
                    <div>
                      <select
                        ...
                        v-model="creditNoteData.specialDiscountTaxPolicy"
                        class="py-1 px-2 border border-gray-400 w-full rounded"
                        name
                        id
                      >
          ...
          <hr class="mt-5" />
            ...
            <div class="flex justify-between">
              <div class="w-1/3">
                <textarea
                  v-model="creditNoteData.comment"
                  class="w-full py-3 px-2 border border-gray-400 rounded"
              ...
              <table class="table">
                <tbody>
                  <tr v-for="(vat, index) in calTotalTaxPolicy" :key="index">
                    <td class="px-6 py-3 whitespace-no-wrap text-gray-600">{{vat.name}}</td>
                    <td class="px-6 py-3 whitespace-no-wrap">
                      <span class="tracking-widest">{{vat.amount | currency}}</span>
                    </td>
                    <td class="px-6 py-3 whitespace-no-wrap"></td>
                  </tr>

                  <tr>
                    <td class="px-6 py-3 whitespace-no-wrap text-gray-600">Total Sales Tax</td>
                    <td class="px-6 py-3 whitespace-no-wrap">
                      <span class="tracking-widest">{{calTotalSalesTax | currency}}</span>
                    </td>
                    <td class="px-6 py-3 whitespace-no-wrap"></td>
                  </tr>

                  <tr>
                    <td class="px-6 py-3 whitespace-no-wrap text-gray-600">Invoice Total</td>
                    <td class="px-6 py-3 whitespace-no-wrap">
                      <span class="tracking-widest">{{calSalesInvoiceTotal | currency}}</span>
                    </td>
                    <td class="px-6 py-3 whitespace-no-wrap"></td>
                  </tr>

                  <tr>
                    <td class="px-6 py-3 whitespace-no-wrap text-gray-600">Total Customer Discount</td>
                    <td class="px-6 py-3 whitespace-no-wrap">
                      <span class="tracking-widest">{{calTotalCustomerDiscount | currency}}</span>
                    </td>
                    <td class="px-6 py-3 whitespace-no-wrap"></td>
                  </tr>
                </tbody>
      ...
      <!-- Footer-->
        ...
        <div class="flex justify-between">
          ...
          <div>
            <button
              :disabled="saveButton"
              :class="{'cursor-not-allowed' :saveButton , 'bg-cloudenly-primary-off' : saveButton, 'text-white': saveButton}"
             
              type=" button"
              class="mr-5 px-5 rounded-full py-3 bg-gray-200 text-primary-optima-color"
            >
              <feather-icon
                v-show="saveButton"
...
export default {
  ...
  methods: {
        ...
        if (val.hasOwnProperty("retailPriceBooks")) {
          ...
          if (type === "promoPrice") {
            this.selectedItem.push({
              ...
              invoiceTaxPolicyRates: val.item.taxes.map((resp) => {
                return {
                  name: resp.name,
                  amount: resp.amount,
                };
    ...
    selectCustomer() {
      ...
      this.selectedItem = [];
      this.creditNoteData.billingAddress = this.selectedCustomer.address;
      this.creditNoteData.deliveryAddress = this.selectedCustomer.address;
    },
    ...
    calShippingCharge() {
      ...
      let shippingChargeTaxPolicy = this.creditNoteData.shippingChargeTaxPolicy;
      this.isDeliveryTaxOpen = false;
      switch (shippingChargeTaxPolicy) {
        ...
        case "taxExclusive":
          ...
          this.creditNoteData.totalTaxOnShippingCharge =
            (parseInt(this.creditNoteData.shippingCharge) * exclusiveTotalTaxes) /
            100;
          this.creditNoteData.invoiceShippingChargeTaxes = this.allVat.taxes.map(
            (resp) => {
              return {
                taxId: resp.id,
                name: resp.name,
                ...
                rate: resp.amount,
                amount:
                  (Number(resp.amount) * this.creditNoteData.shippingCharge) / 100,
              };
            }
          );
          break;
        ...
        case "taxInclusive":
          ...
          let lineTotalExcludingTax =
            parseInt(this.creditNoteData.shippingCharge) /
        ...
        // eslint-disable-next-line no-case-declarations
        case "taxExempt":
          this.creditNoteData.totalTaxOnShippingCharge = 0;
          this.creditNoteData.invoiceShippingChargeTaxes = this.allVat.taxes.map(
            (resp) => {
              return {
                taxId: resp.id,
                ...
                label: resp.label,
                rate: resp.amount,
                amount: (0 * this.creditNoteData.shippingCharge) / 100,
              };
            }
          );
          break;
    ...
    calTaxSpecialDiscount() {
      let specialDiscountTaxPolicy = this.creditNoteData.specialDiscountTaxPolicy;
      ...
      switch (specialDiscountTaxPolicy) {
        ...
        case "taxExclusive":
          ...
          let exclusiveTotalTaxes = exclusiveTotal;
          this.creditNoteData.totalTaxOnSpecialDiscount =
            (parseInt(this.creditNoteData.specialDiscount) * exclusiveTotalTaxes) /
            100;
          this.creditNoteData.invoiceSpecialDiscountTaxes = this.allVat.taxes.map(
            (resp) => {
              return {
                taxId: resp.id,
                name: resp.name,
                ...
                rate: resp.amount,
                amount:
                  (Number(resp.amount) * this.creditNoteData.specialDiscount) /
                  100,
              };
            }
          );
        ...
        case "taxInclusive":
          ...
          let lineTotalExcludingTax =
            parseInt(this.creditNoteData.specialDiscount) /
            (1 + inclusiveTotalTaxes / 100);
          this.creditNoteData.totalTaxOnSpecialDiscount =
            (parseInt(lineTotalExcludingTax) * inclusiveTotalTaxes) / 100;
        ...
        // eslint-disable-next-line no-case-declarations
        case "taxExempt":
          this.creditNoteData.totalTaxOnSpecialDiscount = 0;
          this.creditNoteData.invoiceSpecialDiscountTaxes = this.allVat.taxes.map(
            (resp) => {
              return {
                name: resp.name,
    ...
    saveInvoice() {
      ...
      this.creditNoteData.invoiceBoqTotalTaxes = this.totalTaxRate;
      this.creditNoteData.invoiceBoqs = this.selectedItem;

      let userInfo = this.$store.state.auth.auth.authData;

      let data = {
        userInfo: userInfo,
        payload: this.creditNoteData,
      };
  ...
  computed: {
    ...
    calTotalSubLineTotalDiscountAmount() {
      ...
      return (this.creditNoteData.totalSubLineTotalDiscountAmount = totalSubLineTotalDiscountAmount);
    },
    ...
    calTotalSubLineTotalExcludingTax() {
      ...
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      this.creditNoteData.totalSubLineTotalExcludingTax = totalSubLineTotalExcludingTax;
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      return this.creditNoteData.totalSubLineTotalExcludingTax;
      // return (this.creditNoteData.totalExTaxAmount = totalExTax);
    },
    ...
    calTotalSubLineTotalTaxAmount() {
      ...
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      this.creditNoteData.taxSubTotal = totalSubLineTotalTaxAmount;
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      return (this.creditNoteData.totalSubLineTotalTax = totalSubLineTotalTaxAmount);
    },

    calTotalSalesTax() {
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      this.creditNoteData.salesTaxTotal =
        parseInt(this.creditNoteData.totalSubLineTotalTax || 0) +
        parseInt(this.creditNoteData.totalTaxOnShippingCharge || 0) -
        parseInt(this.creditNoteData.totalTaxOnSpecialDiscount || 0);
      return this.creditNoteData.salesTaxTotal;
    },

    // invoice total
    calSalesInvoiceTotal() {
      let total =
        parseInt(this.creditNoteData.totalSubLineTotalExcludingTax || 0) +
        parseInt(this.creditNoteData.shippingCharge || 0) -
        parseInt(this.creditNoteData.specialDiscount || 0);
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      return (this.creditNoteData.invoiceTotal =
        parseInt(total) + parseInt(this.creditNoteData.salesTaxTotal));
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      // return this.creditNoteData.totalSaleInvoice = parseInt(total) + parseInt(this.creditNoteData.salesTaxTotal)
    },

    // total customer discount
    calTotalCustomerDiscount() {
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      this.creditNoteData.totalCustomerDiscount =
        parseInt(this.creditNoteData.totalSubLineTotalDiscountAmount | 0) +
        parseInt(this.creditNoteData.specialDiscount | 0);
      // eslint-disable-next-line vue/no-side-effects-in-computed-properties
      this.creditNoteData.totalDiscount = this.creditNoteData.totalCustomerDiscount;
      return this.creditNoteData.totalCustomerDiscount;
    },
    ...
    calTotalTaxPolicy() {
      ...
      tax.push(this.creditNoteData.invoiceSpecialDiscountTaxes);
      tax.push(this.creditNoteData.invoiceShippingChargeTaxes);
  ...
  mounted() {
    ...
    this.$store
      ...
      .then((resp) => {
        this.creditNoteData.invoiceNumber = resp.data.code;
        this.$vs.loading.close("#div-with-loading > .con-vs-loading");
      });
