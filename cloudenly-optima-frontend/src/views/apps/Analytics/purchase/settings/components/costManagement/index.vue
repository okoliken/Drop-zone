  ...
  <div class="grid grid-cols-12 bg-white px-6 py-8 mb-5" style="height: 400px;">
    ...
    >
      <div class="flex items-center justify-between">
        <h2 class="font-bold">Cost Management</h2>
      ...
      <div>
        <vue-apex-charts
          ...
          height="200"
          width="100%"
          :options="costManagement.line.options"
          :series="costManagement.line.series"
        />
    ...
    <div class="col-span-5 flex flex-col justify-between pl-6">
      <!-- donut header options -->
      <div class="flex flex-col">
        <h2 class="mr-12 font-bold mb-3">Overall Per Supplier</h2>

        <div class="flex">
          <s-select
            :width="290"
            :height="27"
            defaultOption="All Product Categories"
          />
        </div>
      </div>
      ...
      <div class="w-full h-full flex items-center">
        <div class="w-6/12 flex items-center" style="height: 250px;">
          <vue-apex-charts
            type="donut"
            height="100%"
            :options="costManagement.donut.options"
            :series="costManagement.donut.series"
          />
        </div>
...
export default {
  name: "AnalyticsPurchaseNumberOfSuppliers",
