  ...
  <div class="grid grid-cols-12 bg-white px-6 py-8 mb-5" style="height: 400px;">
    <div class="col-span-5 flex flex-col justify-between">
      ...
      <div class="flex items-center">
        <h2 class="mr-12 font-bold">Number of Suppliers</h2>

        <s-select :width="100" :height="27" defaultOption="Top 3" />
      </div>
      ...
      <div class="w-full h-full flex items-center">
        <div class="w-6/12 flex items-center" style="height: 250px;">
          <vue-apex-charts
            type="donut"
            height="100%"
            :options="numberOfSuppliers.donut.options"
            :series="numberOfSuppliers.donut.series"
          />
        </div>
    ...
    >
      ...
      <div>
        <vue-apex-charts
          ...
          height="200"
          width="100%"
          :options="numberOfSuppliers.line.options"
          :series="numberOfSuppliers.line.series"
        />
