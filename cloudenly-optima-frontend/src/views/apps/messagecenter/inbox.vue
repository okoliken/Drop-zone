    ...
    >
      ...
      >
        <li
          ...
          v-for="(mail, index) in allRecieveMessage"
...
// import { quillEditor } from "vue-quill-editor";clear
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("messageCenter", ["allRecieveMessage"]),
  },
  ...
  mounted() {
    this.$store.dispatch("messageCenter/getReceivedMessage");
  },
};
</script>
