<template>
  <div>
    <vs-sidebar
      ...
      class="full-vs-sidebar email-view-sidebar"
      v-model="isSidebarActive"
      position-right
    >
      <div
        class="mail-sidebar-content px-0 sm:py-6 pt-2 h-full"
        v-if="currentMail"
      >
        <div
          class="flex flex-wrap items-center email-header justify-between md:px-8 px-6 sm:pb-2"
        >
          <div class="flex mb-4">
                ...
                <vs-dropdown-menu>
                  <ul class="my-2">
                    <li
                      ...
                      v-if="currentMail.mailType != 'inboxed'"
                    >
                    ...
                    <li
                      ...
                      v-if="currentMail.mailType != 'drafted'"
                    >
                      <feather-icon
                        icon="Edit2Icon"
                        svg-classes="h-5 w-5"
                    ...
                    <li
                      class="px-4 mb-2 flex items-start cursor-pointer hover:text-primary"
                      @click="moveTo('spam')"
                      v-if="currentMail.mailType != 'spam'"
                    >
                      <feather-icon
                        icon="InfoIcon"
                        svg-classes="h-5 w-5"
                    ...
                    <li
                      ...
                      v-if="currentMail.mailType != 'trashed'"
                    >
                      <feather-icon
                        icon="TrashIcon"
                        svg-classes="h-5 w-5"
            ...
            >
              <div class="vx-col w-full">
                <vx-card class="px-4 mb-10">
                  ...
                  <div class="vx-row">
                    <div
                      class="vx-col w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid justify-between flex items-center"
                    >
                      <div class="flex items-center">
                        <div>
                              ...
                              <vs-dropdown-menu style="z-index: 40001">
                                <div class="p-2">
                                  ...
                                  <p class="text-sm mb-1">
                                    Date:
                                    <span class="font-semibold">
                                      {{ threadMail.time | time }}
                                      {{ threadMail.time | date(true) }}
                                    </span>
                                  </p>
                                  <p
                                    class="text-sm mb-1"
                                    v-if="threadMail.cc.length"
                                  >
                                    cc:
                                    <span class="font-semibold">
                                      {{ threadMail.cc | csv }}
                  ...
                  <div class="vx-row" v-if="threadMail.attachments.length">
                    <div
                      class="vx-col w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid mb-6 flex"
                    >
                    ...
                    <div class="flex">
                      <div
                        ...
                        v-for="(attachment, index) in threadMail.attachments"
                        :key="index"
                      >
            ...
            <div class="vx-row">
              <div class="vx-col w-full">
                <vx-card class="px-4">
                  <!-- MAIL META ROW -->
                  <div
                    class="vx-row w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid justify-between flex items-center"
                  >
                    <div
                      class="vx-col sm:w-4/5 w-full flex flex-wrap items-center mb-2"
                    >
                            ...
                            <vs-dropdown-menu style="z-index: 40001">
                              <div class="p-2">
                                ...
                                <p class="text-sm mb-1">
                                  Date:
                                  <span class="font-semibold">
                                    {{ currentMail.time | time }}
                                    {{ currentMail.time | date(true) }}
                                  </span>
                                </p>
                                <p
                                  class="text-sm mb-1"
                                  v-if="currentMail.cc.length"
                                >
                                  cc:
                                  <span class="font-semibold">
                                    {{ currentMail.cc | csv }}
                    ...
                    >
                      <span
                        class="flex sm:mr-0 mr-2 self-end whitespace-no-wrap"
                        >{{ currentMail.time | time }}</span
                      >
                      <span
                        class="flex self-end sm:mt-2 mt-0 whitespace-no-wrap"
                        >{{ currentMail.time | date(true) }}</span
                      >
                    </div>
                  </div>
...
export default {
  ...
  updated() {
    if (this.currentMail.unread && this.isSidebarActive)
      this.$store.dispatch("email/updateMailUnread", {
