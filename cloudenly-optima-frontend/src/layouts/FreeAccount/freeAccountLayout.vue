<template>
  <div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
    <vx-sidebar :sidebarItems="sidebarItems" title="Optima" parent=".layout--main" /> 
...
<script>
import VxSidebar from "../FreeAccount/freeAccountSideBar";
import TheCustomizer from "../components/customizer/TheCustomizer.vue";
import TheNavbar from "../components/FreeAccountNavbar";
import TheFooter from "../components/TheFooter.vue";
import themeConfig from "@/../themeConfig.js";
import sidebarItems from "../FreeAccount/freeSidebarItem";
