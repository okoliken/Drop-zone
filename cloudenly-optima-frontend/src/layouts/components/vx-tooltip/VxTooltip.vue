<template>
  <div ref="convstooltip" class="con-vs-tooltip"  @mouseout="mouseoutx"  @mouseover="mouseoverx">
    <transition name="tooltip-fade">
      <div  v-show="active"  ref="vstooltip" :class="[`vs-tooltip-${positionx || position}`,`vs-tooltip-${color}`, {'after-none': noneAfter}]"
