<template lang="html">
  <div class="parentx">
    ...
    >
      ...
      >
        <div class="py-5 flex items-center bg-white" slot="header">
          <div class=" mx-auto flex items-center">
            <!-- <img class="  mr-5" src="../../../assets/images/optimaAsset/optimaLogo.svg"  /> -->
            <router-link class="mx-auto" :to="{ path: '/dashboard/analytics' }">
              <div class=" text-xl font-bold tracking-wide">
                <span v-show="isMouseEnter || !reduce" v-if="title">
                  {{ title }}</span
                >
              </div>
            </router-link>
